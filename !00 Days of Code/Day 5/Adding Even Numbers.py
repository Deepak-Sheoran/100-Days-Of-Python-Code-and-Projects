# Instructions
# You are going to write a program that calculates the sum of all the even numbers from 1 to X. If X is
...
for num in range(2, target + 1, 2):
    sum_even += num
print(f"The sum even number for 0 to {target} = {sum_even}")
